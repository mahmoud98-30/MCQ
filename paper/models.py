...
class Correction(models.Model):
    ...
    correct_image = models.ForeignKey(Correct, on_delete=models.CASCADE, blank=True, null=True, )
    ...
    class Meta:
        ...
        verbose_name_plural = _('correction')

    def __str__(self):
        return self.answer_image.path

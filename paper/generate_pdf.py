...
def generate_pdf(RQ, logo, name, school_name, class_room, teacher, suject, student_code):
    ...
    pdf.image(RQ, x=10, y=8, w=30)

    pdf.image(logo, x=160, y=8, w=30)
    ...
    # write class room
    class_room_name = u'class :' + str(class_room)
    pdf.cell(130, 10, class_room_name, )

    # write student name
    student_name = u'name :' + str(name)
    ...
    # write teacher name
    teacher_name = u'teacher :' + teacher
    pdf.cell(130, 10, teacher_name, )

    # write student code
    code = u'student code :' + student_code
    pdf.cell(80, 10, code, )
    ...
    filename = "_".join([teacher, suffix, name,])
